...
const SubjectEditForm = (props) => {
  ...
  const handleSubmit = (e, _id) => {
    e.preventDefault();
    axios.put(`http://localhost:8080/api/subject/${data._id}`, data).then((r) => {
        ...
        <Grid container spacing={8}>
          <Grid item lg={12} md={12} sm={12} xs={12} sx={{ mt: 2 }}>
            ...
            >
              ...
              <option>
                https://img.freepik.com/free-vector/flat-pattern-design-back-school-season_23-2150608577.jpg
              </option>
              <option>
